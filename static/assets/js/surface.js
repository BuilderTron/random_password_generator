...
function renderFSS(el) {
  var MESH = {
    ...
    yRange: 0.1,
    zRange: 1.0,
    ambient: el.dataset.meshambient,
    diffuse: el.dataset.meshdiffuse,
    speed: 0.0001
  };
  var LIGHT = {
    count: 1,
    xyScalar: 1,
    zOffset: 100,
    ambient: el.dataset.lightambient,
    diffuse: el.dataset.lightdiffuse,
    speed: 0.0002,
    gravity: 500,
    dampening: 0.95,
    minLimit: 10,
  ...
  var container = el;
  var output = el.getElementsByClassName('surface')[0];
  ...
  var containers = document.getElementsByClassName('background');
  for (var i = containers.length - 1; i >= 0; i--) {
    renderFSS(containers[i])
  }
})()
